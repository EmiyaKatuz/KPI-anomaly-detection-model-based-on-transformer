...
if __name__ == '__main__':
    ...
    # parser.add_argument('--patch_size', type=list, default=[1,3,5])
    ...
    parser.add_argument('--data_path', type=str, default='PSM')
    parser.add_argument('--model_save_path', type=str, default='checkpoints')

    # parser.add_argument('--anormly_ratio', type=float, default=1)
    parser.add_argument('--anormly_ratio', type=float, default=0.7)
